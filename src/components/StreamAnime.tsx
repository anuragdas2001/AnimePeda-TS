...
export const StreamAnime: React.FC = () => {
    ...
    const fetchStream = async () => {
      if (anime && episode) {
        try {
          ...
          console.log(`${url}/${formattedTitle}-${episode}`);
          console.log(res);
          setData(res.data);
          console.log(res.data);
          if (res.data.nspl.main) {
            setVideoUrl(res.data.nspl.main);
          } else {
            setVideoUrl(res.data.nspl.backup);

            if (res.data.plyr.main) {
              setVideoUrl(res.data.plyr.main);
            } else {
              setVideoUrl(res.data.plyr.backup);
            }
          }
        //   setVideoUrl(res.data.plyr.main);
